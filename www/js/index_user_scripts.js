...
function submit_check_first(){
		...
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/dianaapp/dianafrontend/api_registration.php',
			    data: {
...
function submit_to_joomla2(name,username,password1,password2,email1,email2,option,task){
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/dianaapp/index.php', //url of joomla website
			    data: {
			    	'option': option,
			    	'task': task,
			    	'jform[name]':name,
...
//    START CONNECT TO JOOMLA BACKEND
	...
	function submit_to_joomla(){ 
		...
		$.ajax({
                type: "POST",
                url: "http://user.mydroid.io/dianaapp/dianafrontend/api_login.php",
                data: {
                    username: jform_username,
...
//    Pull data drom MySQL for feeedback
     $( document ).ready(function() {
			    $.ajax({
				    url: 'http://user.mydroid.io/dianaapp/api.php?private_key=e4ed5acb3a53e3935a1a8f1676fb111de2a4842a',
				    type: "get",
				    dataType: "json",
				    success: function(response) {
...
//    Pull data drom MySQL for feeedback
    ...
    {
        var $form = $( this ),
        url = "http://user.mydroid.io/dianaapp/diana.php";
        var posting = $.post( url, { fullname: $('#fullname').val(), email: $('#email').val(), telephone: $('#telephone').val(), 
                                     message: $('#message').val() } );
